...
function Navbar() {
  return (
    <div className="fixed bottom-0 w-full bg-white border-t border-gray-200 flex justify-around py-2">
      ...
      {/* Add Friend Link - Opens the page to add new friends */}
      <Link to="/add-friend" className="text-gray-700" aria-label="Add Friend">
        <svg className="w-6 h-6" fill="none" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
      ...
      <Link to="/split-bill" className="text-gray-700" aria-label="Add Receipt">
        <svg className="w-6 h-6" fill="none" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
